...
export namespace Prisma {
  ...
  */
  ...
  export type SampleAggregateArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
  ...
  type GetSampleGroupByPayload<T extends SampleGroupByArgs> =
  ...
  type SampleGetPayload<
    S extends boolean | null | undefined | SampleDefaultArgs,
  > = $Result.GetResult<Prisma.$SamplePayload, S>;

  type SampleCountArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = Omit<SampleFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
    select?: SampleCountAggregateInputType | true;
  };

  export interface SampleDelegate<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
    GlobalOmitOptions = {},
  > {
    [K: symbol]: {
     ...
     * })
     */
    findUnique<T extends SampleFindUniqueArgs>(
      args: SelectSubset<T, SampleFindUniqueArgs<ExtArgs>>,
    ): Prisma__SampleClient<
      $Result.GetResult<
        Prisma.$SamplePayload<ExtArgs>,
        T,
        'findUnique',
        GlobalOmitOptions
      > | null,
     ...
     * })
     */
    findUniqueOrThrow<T extends SampleFindUniqueOrThrowArgs>(
     ...
     * })
     */
    findFirst<T extends SampleFindFirstArgs>(
     ...
     * })
     */
    findFirstOrThrow<T extends SampleFindFirstOrThrowArgs>(
     ...
     *
     */
    findMany<T extends SampleFindManyArgs>(
     ...
     *
     */
    create<T extends SampleCreateArgs>(
     ...
     *
     */
    createMany<T extends SampleCreateManyArgs>(
     ...
     *
     */
    delete<T extends SampleDeleteArgs>(
     ...
     *
     */
    update<T extends SampleUpdateArgs>(
     ...
     *
     */
    deleteMany<T extends SampleDeleteManyArgs>(
     ...
     *
     */
    updateMany<T extends SampleUpdateManyArgs>(
     ...
     * })
     */
    upsert<T extends SampleUpsertArgs>(
     ...
     * })
     **/
    aggregate<T extends SampleAggregateArgs>(
      args: Subset<T, SampleAggregateArgs>,
    ): Prisma.PrismaPromise<GetSampleAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, SampleGroupByArgs, OrderByArg> & InputErrors,
    ): {} extends InputErrors
      ? GetSampleGroupByPayload<T>
   ...
   */
  export interface Prisma__SampleClient<
    T,
    Null = never,
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
    GlobalOmitOptions = {},
   ...
   * Sample findUnique
   */
  export type SampleFindUniqueArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
   ...
   */
  export type SampleFindUniqueOrThrowArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Sample
   ...
   * Sample findFirst
   */
  export type SampleFindFirstArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Sample
   ...
   */
  export type SampleFindFirstOrThrowArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Sample
   ...
   * Sample createMany
   */
  export type SampleCreateManyArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
   ...
   * Sample updateMany
   */
  export type SampleUpdateManyArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
   ...
   * Sample deleteMany
   */
  export type SampleDeleteManyArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
  ...
  export type SampleScalarFieldEnum =
    (typeof SampleScalarFieldEnum)[keyof typeof SampleScalarFieldEnum];
  ...
  export type SampleOrderByRelevanceFieldEnum =
    (typeof SampleOrderByRelevanceFieldEnum)[keyof typeof SampleOrderByRelevanceFieldEnum];
